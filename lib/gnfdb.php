...
abstract class gnfDB_Base implements gnfDBinterface
{
	private $dump;
	public $db;
 ...
 */
class gnfDB_mysql extends gnfDB_Base
{
	public function gnfDB_mysql($host = null, $id = null, $pass = null)
	{
		parent::__construct();
		$this->host = $host;
		$this->id = $id;
...
class gnfDB_PDO extends gnfDB_Base
{
	private $select_db;
